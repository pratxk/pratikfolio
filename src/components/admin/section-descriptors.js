    ...
    fields: [
      {
        ...
        itemFields: [
          ...
          { key: "navbar", type: "toggle", label: "Show in navbar" },
          { key: "title", type: "text", label: "Title" },
          { key: "route", type: "text", label: "Route (e.g. /projects/foo)" },
          { key: "meta_title", type: "text", label: "Meta title" },
          { key: "meta_description", type: "text", label: "Meta description" },
          { key: "description", type: "textarea", label: "Description (markdown/gradient supported)" },
          { key: "images", type: "imageArray", label: "Images" },
          { key: "tags", type: "stringArray", label: "Tags" },
          {
            key: "content",
            type: "array",
            ...
            itemFields: [
              { key: "type", type: "text", label: "Block type (text / features / posts)" },
              { key: "title", type: "text", label: "Block title (features)" },
              { key: "content", type: "textarea", label: "Text (text blocks)" },
              { key: "items", type: "stringArray", label: "Items (features blocks)" },
            ],
          },
          {
            key: "statistics",
            ...
            label: "Statistics",
            addLabel: "Add stat",
            newEntry: () => ({ title: "", description: "", value: "", color: "blue" }),
            itemFields: [
              { key: "title", type: "text", label: "Title" },
              { key: "description", type: "text", label: "Description" },
              { key: "value", type: "text", label: "Value" },
              { key: "color", type: "text", label: "Color (blue/green/purple/orange)" },
            ],
          },
          {
            key: "buttons",
            ...
            label: "Buttons",
            addLabel: "Add button",
            newItem: { label: "", route: "", style: "primary" },
            itemFields: [
              { key: "label", type: "text", label: "Label" },
              { key: "route", type: "text", label: "URL" },
              { key: "style", type: "text", label: "Style (primary/secondary)" },
            ],
          },
        ],
      },
